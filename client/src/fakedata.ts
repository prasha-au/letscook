...
export const DATA = {
  ...
  "ingredients": [
    {
      "ingredients": [
        ...
        },
        {
          ...
          "amount": "4",
          "unit": "stalks",
          "notes": ", green parts only, cut into 2 inch pieces"
        }
      ]
    }
  ],
  "instructions": [
    {
      "steps": [
        "Slice the flank steak against the grain (the grain is the length of the steak) the long way ¼ inch think pieces and add it to a ziploc bag with the cornstarch.",
